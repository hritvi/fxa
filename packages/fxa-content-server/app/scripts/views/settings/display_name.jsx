...
function DisplayNameFormComponent(props) {
  return (
    <form novalidate>
      ...
      <div class="input-row">
        <input type="text" class="text display-name" placeholder="Display name" value={props.displayName} autofocus  autocomplete="off"/>
      </div>
...
const View = FormView.extend({
  ...
  afterVisible () {
    ReactDOM.render(
      <Te displayName="Hey" />,
      // <ReactMustache template="Welcome {{displayName}}" data={{displayName: 'Mr. Gregory'}} />,
      this.$el.get(0)
    );
  },
